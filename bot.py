...
BOT_TOKEN = os.getenv("8710734243:AAHj0QoIRpSDAVnoxodtfzwenAcV-PV-6sY")
MONGODB_URI = os.getenv("mongodb+srv://pramil:cSnJK0jIZ9FSfIAF@cluster0.ycf4z0g.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = os.getenv("DATABASE_NAME", "attack_bot")
API_URL = os.getenv("https://www.google.com/url?q=https://link.userlistmail.com/c/73fce8122c080eb9640f0cf1b2d4703da2a1927fd92911fef0d10c74ef7defc028bd0c2d2d6442049af598a67f82ee0a01bea18786d095d84cb9f35113795a30cfc97d5ef1e2936e1704dd9c2db360761f013aeb6a7683921a09b8cfbf942356cc2ccfa885f8af6287713c9ba9b92305&source=gmail&ust=1775840225907000&usg=AOvVaw0A8sDGGXosADeKnCFV8ru-")
API_KEY = os.getenv("ofapi_GCALSjDAj7OIjODPy7jAzvp11jqmhD3bXz3SMOnG7743ca17")
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "918819720").split(",")]
